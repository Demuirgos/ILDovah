public record VtfixupAttrDecl(String[] Attributes) : Decl {
    ...
    public static bool Parse(ref int index, string source, out VtfixupAttrDecl vtfixupAttrDecl) {
        int start = index;
...
public record VtfixupDecl(long number, String[] Attributes, String Id) : Decl {
    ...
    public static bool Parse(ref int index, string source, out VtfixupDecl? vtfixupDecl) {
