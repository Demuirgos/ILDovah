...
public record StructuralExceptionBlock(TryBlock TryBlock, WireBlock.Collection Clauses) : IDeclaration<StructuralExceptionBlock> {
    ...
    public static Parser<StructuralExceptionBlock> AsParser => RunAll(
        ...
        Map(
            converter: tryBlock => new StructuralExceptionBlock(tryBlock, null),
            TryBlock.AsParser
        ),
        Map(
...
public record TryBlock : IDeclaration<TryBlock> {
    public record TryWithLabel(Label From, Label To) : TryBlock, IDeclaration<TryWithLabel> {
    ...
    public record TryWithScope(MethodBodyItem.ScopeBlock ScopeBlock) : TryBlock, IDeclaration<TryWithScope> {
        ...
        public static Parser<TryWithScope> AsParser => RunAll(
            ...
            Map(
                ...
                MethodBodyItem.ScopeBlock.AsParser
            )
        );
    }

    public static Parser<TryBlock> AsParser => TryRun(Id,
        Cast<TryBlock, TryWithLabel>(TryWithLabel.AsParser),
        Cast<TryBlock, TryWithScope>(TryWithScope.AsParser)
    );
}
...
public record HandlerBlock : IDeclaration<HandlerBlock> {
    ...
    public record HandlerWithScope(MethodBodyItem.ScopeBlock ScopeBlock) : HandlerBlock, IDeclaration<HandlerWithScope> {
